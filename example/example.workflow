...
steps:
#- {name: build, uses: qemu.build_x86}
#- {name: install, uses: qemu.install}
#- {name: provision, uses: qemu.guest_provision}
- {name: start, uses: qemu.guest_start}
...
#- {name: kill, uses: qemu.guest_kill}
