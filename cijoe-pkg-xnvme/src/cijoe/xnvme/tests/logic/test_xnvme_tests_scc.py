...
def test_idfy(cijoe, device, be_opts, cli_args):
    ...
    rcode, _ = cijoe.run(f"xnvme_tests_scc idfy {cli_args}")
    assert not rcode
...
def test_support(cijoe, device, be_opts, cli_args):
    ...
    rcode, _ = cijoe.run(f"xnvme_tests_scc support {cli_args}")
    assert not rcode
...
def test_scopy(cijoe, device, be_opts, cli_args):
    ...
    rcode, _ = cijoe.run(f"xnvme_tests_scc scopy {cli_args}")
    assert not rcode
...
def test_scopy_clear(cijoe, device, be_opts, cli_args):
    ...
    rcode, _ = cijoe.run(f"xnvme_tests_scc scopy {cli_args} --clear")
    assert not rcode
...
def test_scopy_msrc(cijoe, device, be_opts, cli_args):
    ...
    rcode, _ = cijoe.run(f"xnvme_tests_scc scopy-msrc {cli_args}")
    assert not rcode
...
def test_scopy_msrc_clear(cijoe, device, be_opts, cli_args):
    ...
    rcode, _ = cijoe.run(f"xnvme_tests_scc scopy-msrc {cli_args} --clear")
    assert not rcode
